...
const InsightCard = ({ imgUrl, title, subtitle, index}) => (
  <motion.div variants={fadeIn('up', 'spring', index * 0.5, 1)} className="flex md:flex-row flex-col gap-4">
    <img src={imgUrl} alt="planet1" className="md:w-72 w-full h-64 rounded-3xl object-cover"/>
    <div className="w-full flex justify-between items-center">
      ...
      <div className="lg:flex hidden items-center justify-center w-24 h-24 rounded-full bg-transparent border-[-1px] border-white">
