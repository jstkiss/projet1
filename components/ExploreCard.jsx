...
const ExploreCard = ({ id, imgUrl, title, index, active, handleClick }) => (
  <motion.div
    ...
    className={`relative ${ active === id ? 'lg:flex-[3.5] flex-[10]' : 'lg:flex-[0.5] flex-[2]'} flex items-center justify-center min-w-[170px] h-[700px] transition-[flex] duration-[0.7s] ease-out-flex cursor-pointer`} onClick={() => handleClick(id)}
  >
    <img
      src={imgUrl}
      alt={title}
    ...
    {active !== id ? (
      ...
      <div className="absolute bottom-0 p-8 justify-start w-full flex-col bg-[rgba(0,0,0,0.5)] rounded-b-3xl">
        <div className={`${styles.flexCenter} w-14 h-14 rounded-3xl glassmorphism mb-4`}>
          <img src="headset.svg" alt="head" className="w-1/2 h-1/2 object-contain" />
        </div>
